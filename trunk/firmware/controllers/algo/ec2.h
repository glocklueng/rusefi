...
void initializeIgnitionActions(float chargeAngle, engine_configuration_s *engineConfiguration, engine_configuration2_s *engineConfiguration2, float dwellAngle, ActuatorEventList *list);
