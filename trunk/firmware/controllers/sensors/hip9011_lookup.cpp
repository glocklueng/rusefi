...
void initEngineNoiseTable(DECLARE_ENGINE_PARAMETER_F) {
	...
	engineConfiguration->knockNoiseBins[0] = 2; // 800
	engineConfiguration->knockNoiseBins[1] = 2; // 1700
	engineConfiguration->knockNoiseBins[2] = 2; // 2600
	engineConfiguration->knockNoiseBins[3] = 2; // 3400
	engineConfiguration->knockNoiseBins[4] = 2; // 4300
	engineConfiguration->knockNoiseBins[5] = 2; // 5200
	engineConfiguration->knockNoiseBins[6] = 2; // 6100
	engineConfiguration->knockNoiseBins[7] = 2; // 7000
