...
public class Fields {
    ...
    public static final Field SENSORCHARTMODE = new Field(@@sensorChartMode_offset@@, FieldType.INT, @@sensor_chart_enum@@);
    ...
    public static final Field TRIGGER_TYPE = new Field(@@trigger_type_offset@@, FieldType.INT, @@trigger_type_enum@@);
    ...
    public static final Field INJECTIONPINS1 = new Field(@@injectionPins1_offset@@, FieldType.INT, @@brain_pin_enum@@);
}