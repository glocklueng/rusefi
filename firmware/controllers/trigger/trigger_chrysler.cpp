...
//	triggerAddEvent(s, 0 , T_SECONDARY, TV_HIGH); // 1
//	triggerAddEvent(s, 20, T_SECONDARY, TV_LOW);
//	triggerAddEvent(s, 40, T_SECONDARY, TV_HIGH);
//	triggerAddEvent(s, 60, T_SECONDARY, TV_LOW);
//
	triggerAddEvent(s, 80, T_SECONDARY, TV_HIGH);
	triggerAddEvent(s,100, T_SECONDARY, TV_LOW);
	triggerAddEvent(s,120, T_SECONDARY, TV_HIGH);
