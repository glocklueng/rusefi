...
void testTriggerDecoder(void) {
	...
	testTriggerDecoder2("testMitsu", MITSU_4G93, 3, 0.3750, 0.3889);
	{
		...
		assertEqualsM2("rpm#1", 16697.5879, eth.engine.triggerCentral.triggerState.instantRpmValue[0], 0.001);
		assertEqualsM2("rpm#2", 16666.6738, eth.engine.triggerCentral.triggerState.instantRpmValue[1], 0.001);
